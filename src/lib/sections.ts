...
export const SECTION_TYPES: SectionTypeDef[] = [
  {
    ...
    fields: [
      { key: "eyebrow", label: "Kleine Zeile über der Überschrift", type: "text" },
      { key: "headline", label: "Überschrift", type: "text" },
      { key: "headlineAccent", label: "Überschrift-Akzent (türkis, 2. Zeile)", type: "text" },
      { key: "intro", label: "Intro-Text (fett)", type: "textarea" },
      {
        key: "bullets",
        label: "Häkchen-Punkte",
        type: "list",
        itemFields: [{ key: "text", label: "Punkt", type: "text" }],
      },
    ...
    defaultData: {
      ...
      headline: "Hundeschule Hundsgescheit",
      headlineAccent: "Hundetraining mit Herz & Verstand",
      intro: "",
      bullets: [],
      image: "",
      primary: [],
